...
> The Rust gr2 prototype is frozen as reference material; active gr2 work is Python-first and governed by the [core-engine seam](gr2/docs/CORE-ENGINE-SEAM.md).
